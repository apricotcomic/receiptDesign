            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="company_tel" class="col-md-4 col-form-label text-md-right">{{ __('Company Tel') }}</label>

                            <div class="col-md-6">
                                <input id="company_tel" type="text" class="form-control @error('company_tel') is-invalid @enderror" name="company_tel" value="{{ old('company_tel') }}" required autocomplete="company_tel" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="company_fax" class="col-md-4 col-form-label text-md-right">{{ __('Company Fax') }}</label>

                            <div class="col-md-6">
                                <input id="company_fax" type="text" class="form-control @error('company_fax') is-invalid @enderror" name="company_fax" value="{{ old('company_fax') }}" required autocomplete="company_fax" autofocus>
